...
## Overview
Global Genes RareX Challenge committee (GGRC) announces our team as one of the winners for this challenge. 
...
- Look up best similar hpo term from orphanet/hpo dataset for a term if the term is not found in the the orpahnet/hpo dataset
  - We used pyhpo package (https://pypi.org/project/pyhpo/) to find similarity between terms  
